...
export default exportAsMessages({
  ...
  options_accessPermissionDescription: '如果 SERPINFO 設定是從另一個裝置同步或以其他方式更改，您可能需要更新存取權限。',
  ...
  options_addSubscriptionDialog_altNameDescription: '當下載的規則集不包含名稱時使用的備用名稱。',
  ...
  options_blacklistHelper: '您可以使用 [匹配模式](https://developer.mozilla.org/en-US/docs/Mozilla/Add-ons/WebExtensions/Match_patterns) 或 [正規表達式](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Guide/Regular_Expressions)。',
  ...
  options_blockWholeSiteDescription: '例如若封鎖「https://a.b.example.uk.com/」，會加入「*://*.example.uk.com/*」規則。',
  ...
  options_enableRulesetSubscriptionURLDescription: '將 $1 重定向至此頁以新增規則集訂閱。',
  ...
  options_enableSerpInfoSubscriptionURLDescription: '將 $1 重定向至此頁以新增 SERPINFO。',
  ...
  options_turnOnSyncDialog_altFlowDescription: '在登入之前，可能會向您請求存取 $1 的權限，但您的個人資訊不會儲存在該網域中。',

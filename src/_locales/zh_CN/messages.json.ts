...
export default exportAsMessages({
  ...
  options_accessPermissionDescription: '如果 SERPINFO 设置从其他设备同步或以其他方式更改，您可能需要更新访问权限。',
  ...
  options_addSubscriptionDialog_altNameDescription: '当下载的规则集不包含名称时使用的备用名称。',
  ...
  options_blacklistHelper: '你可以使用 [匹配模式](https://developer.mozilla.org/zh-CN/docs/Mozilla/Add-ons/WebExtensions/Match_patterns) 或 [正则表达式](https://developer.mozilla.org/zh-CN/docs/Web/JavaScript/Guide/Regular_Expressions)。',
  ...
  options_blockWholeSiteDescription: '例如屏蔽 "https://a.b.example.uk.com/", 会添加 "*://*.example.uk.com/*" 规则',
  ...
  options_enableRulesetSubscriptionURLDescription: '将 $1 重定向到此页面以添加规则集订阅。',
  ...
  options_enableSerpInfoSubscriptionURLDescription: '将 $1 重定向到此页面以添加 SERPINFO。',
  ...
  options_turnOnSyncDialog_altFlowDescription: '在认证之前，您可能会被要求获得访问 $1 的许可，但您的个人信息不会被存储在该域中。',

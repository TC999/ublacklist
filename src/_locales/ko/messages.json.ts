...
export default exportAsMessages({
  ...
  options_blacklistHelper: '[매치 패턴](https://developer.mozilla.org/en-US/docs/Mozilla/Add-ons/WebExtensions/Match_patterns) 또는 [정규 표현식](https://developer.mozilla.org/ko/docs/Web/JavaScript/Guide/Regular_Expressions)을 사용할 수 있습니다.',
  ...
  options_blockWholeSiteDescription: '예를 들어, "https://a.b.example.uk.com/" 를 차단하면 "*://*.example.uk.com/*" 규칙이 추가됩니다.',
  ...
  options_subscriptionFeatureDescription: '구독을 추가하면 해당 URL에서 차단 목록이 정기적으로 다운로드됩니다.',
  ...
  options_syncFeatureDescription: '클라우드를 통해 여러 기기간에 차단 목록을 동기화 할 수 있습니다.',
  options_syncFeatureUpdated: '동기화 기능이 업데이트 되었습니다. 계속 동기화를 사용하려면 "동기화 설정" 버튼을 눌러주세요.',
  ...
  options_turnOnSyncDialog_altFlowDescription: '인증 과정중에 $1 에 대한 데이터 접근 권한을 요청하지만, 개인 정보는 해당 도메인에 저장되지 않습니다.',
